<template>
  <q-page padding>
    <div class="row q-mb-md items-center">
      <div class="col">
        <div class="text-h5">Create Customer</div>
        <div class="text-body2 text-grey-7">Add a new customer to the system</div>
      </div>
      <div class="col-auto">
        <q-btn
          flat
  ...
  setup() {
    ...
    const onSubmit = async () => {
      ...
      try {
        ...
        const response = await api.post('/api/v1/customers', submitData)
    ...
    onMounted(() => {
      ...
      // Check for phone_number in query params (from incoming call)
      if (route.query.phone_number) {
        form.value.mobile = route.query.phone_number
        // Show notification that phone number was auto-filled
        showNotify({
          type: 'info',
          message: `Phone number from call: ${route.query.phone_number}`,
          position: 'top',
          timeout: 3000
        })
      }
